...
public class OldStyleMapActivity extends AppCompatActivity {
        ...
        locationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (ContextCompat.checkSelfPermission(OldStyleMapActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)
    ...
    private void initSettingsButton() {
        ImageButton ibList = (ImageButton) findViewById(R.id.buttonSettings);
        ibList.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
